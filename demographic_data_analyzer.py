...
def calculate_demographic_data(print_data=True):
    ...
    highest_earning_country = (df[df['salary'] == '>50K']['native-country'].value_counts() / df[df['salary'] == '<=50K']['native-country'].value_counts()).idxmax()
    highest_earning_country_percentage = (df[df['salary'] == '>50K']['native-country'].value_counts() / df[df['salary'] == '<=50K']['native-country'].value_counts()).max()*100
